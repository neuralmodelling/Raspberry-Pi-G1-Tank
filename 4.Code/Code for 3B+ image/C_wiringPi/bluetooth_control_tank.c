...
void Tracking_Mode()
{
   ...
   // 1 0 X 0
   // 0 1 X 0
   //Turn right in place,speed is 160,delay 80ms
  ...
  /* else
   {
   	switch(g_trackstate)
	{
		case 1:spin_right(145,145);printf("1\n");break;
		case 2:spin_left(145,145);printf("2\n");break;
		case 3:spin_left(110,110);printf("3\n");break;
		case 4:spin_right(110,110);printf("4\n");break;
		case 5:spin_left(110, 110);printf("5\n");break;
		case 6:spin_right(110,110);printf("6\n");break;
		case 7:run(150,150);printf("7\n");break;
 ...
 void servo_color_carstate()
{
  ...
  back(100,100);            //Avoid stop suddenly
  delay(80);
  brake();
  ...
  RightDistance = (int)distance;    
  printf("rightdistance :%d\n",RightDistance);
 
  //The servo rotates to 180°(left)to measure distance
  servo_appointed_detection(170);
  delay(500);
  distance = Distance_test();  
  LeftDistance = (int)distance;
...
void serial_data_parse()
{
		                    ...
		                    StringFind((const char *)InputString,(const char *)"#",0) > 0)
  {
    ...
    switch (g_CarState)
    {
      ...
      case enLEFT: spin_left(g_CarSpeedControl, g_CarSpeedControl); break;
      case enRIGHT: spin_right(g_CarSpeedControl, g_CarSpeedControl); break;
